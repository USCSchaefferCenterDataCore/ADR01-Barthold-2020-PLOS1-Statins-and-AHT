...
data pde&year._2;
	&set. set pde&year._1;
	&merge. merge pde&year._1 (in=a) pde&prev_year._10 (in=b keep=bene_id thiaso_push_&prev_year.);
	by bene_id;
...
data thiaso_0713;
	...
	* timing variables;
	array ythiaso [*] ythiaso2007-ythiaso2013;
	array ythiasodec [*] ythiaso2013 ythiaso2012 ythiaso2011 ythiaso2010 ythiaso2009 ythiaso2008 ythiaso2007 ;
	do i=1 to dim(ythiaso);
		if ythiaso[i]=1 then thiaso_lastyoo=i+2006;
		if ythiasodec[i]=1 then thiaso_firstyoo=2014-i;
	end;

	thiaso_yearcount=thiaso_lastyoo-thiaso_firstyoo+1;

	* utilization variables;
	array util [*] thiaso_fillperiod_2007-thiaso_fillperiod_2013 thiaso_clms_2007 - thiaso_clms_2013
		thiaso_filldays_2007-thiaso_filldays_2013 thiaso_pdays_2007-thiaso_pdays_2013;
	...
	* total utilization;
	thiaso_clms=sum(of thiaso_clms_2007-thiaso_clms_2013);
	thiaso_filldays=sum(of thiaso_filldays_2007-thiaso_filldays_2013);
	thiaso_pdays=sum(of thiaso_pdays_2007-thiaso_pdays_2013);

	* timing variables;
	thiaso_minfilldt=min(of thiaso_minfilldt_2007-thiaso_minfilldt_2013);
	thiaso_maxfilldt=max(of thiaso_maxfilldt_2007-thiaso_maxfilldt_2013);
...
* create perm;
data reppoly.thiaso_0713p;
	set thiaso_0713;
run;

* checks;
proc means data=thiaso_0713; run;
