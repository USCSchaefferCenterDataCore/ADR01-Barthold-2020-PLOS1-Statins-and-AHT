...
data pde&year._2;
	&set. set pde&year._1;
	&merge. merge pde&year._1 (in=a) pde&prev_year._10 (in=b keep=bene_id aceiso_push_&prev_year.);
	by bene_id;
...
data aceiso_0713;
	...
	* timing variables;
	array yaceiso [*] yaceiso2007-yaceiso2013;
	array yaceisodec [*] yaceiso2013 yaceiso2012 yaceiso2011 yaceiso2010 yaceiso2009 yaceiso2008 yaceiso2007 ;
	do i=1 to dim(yaceiso);
		if yaceiso[i]=1 then aceiso_lastyoo=i+2006;
		if yaceisodec[i]=1 then aceiso_firstyoo=2014-i;
	end;

	aceiso_yearcount=aceiso_lastyoo-aceiso_firstyoo+1;

	* utilization variables;
	array util [*] aceiso_fillperiod_2007-aceiso_fillperiod_2013 aceiso_clms_2007 - aceiso_clms_2013
		aceiso_filldays_2007-aceiso_filldays_2013 aceiso_pdays_2007-aceiso_pdays_2013;
	...
	* total utilization;
	aceiso_clms=sum(of aceiso_clms_2007-aceiso_clms_2013);
	aceiso_filldays=sum(of aceiso_filldays_2007-aceiso_filldays_2013);
	aceiso_pdays=sum(of aceiso_pdays_2007-aceiso_pdays_2013);

	* timing variables;
	aceiso_minfilldt=min(of aceiso_minfilldt_2007-aceiso_minfilldt_2013);
	aceiso_maxfilldt=max(of aceiso_maxfilldt_2007-aceiso_maxfilldt_2013);
...
* create perm;
data reppoly.aceiso_0713p;
	set aceiso_0713;
run;

* checks;
proc means data=aceiso_0713; run;
