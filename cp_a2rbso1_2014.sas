...
data pde&year._2;
	&set. set pde&year._1;
	&merge. merge pde&year._1 (in=a) reppoly.a2rbso_&prev_year.p (in=b keep=bene_id a2rbso_push_&prev_year.);
	by bene_id;
...
*/
%a2rbsopull(2014,2013,,*);

/*********** Merge a2rbso 07-14 **********/
data a2rbso_0714;
	merge reppoly.a2rbso_2007p (in=b)
				reppoly.a2rbso_2008p (in=c)
				reppoly.a2rbso_2009p (in=d)
				reppoly.a2rbso_2010p (in=e)
				reppoly.a2rbso_2011p (in=f)
				reppoly.a2rbso_2012p (in=g)
				reppoly.a2rbso_2013p (in=h)
				reppoly.a2rbso_2014p (in=i);
	by bene_id;
	ya2rbso2007=b;
	ya2rbso2008=c;
	ya2rbso2009=d;
	...
	* timing variables;
	array ya2rbso [*] ya2rbso2007-ya2rbso2014;
	array ya2rbsodec [*] ya2rbso2014 ya2rbso2013 ya2rbso2012 ya2rbso2011 ya2rbso2010 ya2rbso2009 ya2rbso2008 ya2rbso2007 ;
	do i=1 to dim(ya2rbso);
		if ya2rbso[i]=1 then a2rbso_lastyoo=i+2006;
		if ya2rbsodec[i]=1 then a2rbso_firstyoo=2015-i;
	end;

	a2rbso_yearcount=a2rbso_lastyoo-a2rbso_firstyoo+1;

	* utilization variables;
	array util [*] a2rbso_fillperiod_2007-a2rbso_fillperiod_2014 a2rbso_clms_2007 - a2rbso_clms_2014
		a2rbso_filldays_2007-a2rbso_filldays_2014 a2rbso_pdays_2007-a2rbso_pdays_2014;
	...
	* total utilization;
	a2rbso_clms=sum(of a2rbso_clms_2007-a2rbso_clms_2014);
	a2rbso_filldays=sum(of a2rbso_filldays_2007-a2rbso_filldays_2014);
	a2rbso_pdays=sum(of a2rbso_pdays_2007-a2rbso_pdays_2014);

	* timing variables;
	a2rbso_minfilldt=min(of a2rbso_minfilldt_2007-a2rbso_minfilldt_2014);
	a2rbso_maxfilldt=max(of a2rbso_maxfilldt_2007-a2rbso_maxfilldt_2014);
...
* create perm;
data reppoly.a2rbso_0714p;
	set a2rbso_0714;
run;

* checks;
proc means data=a2rbso_0714; run;
