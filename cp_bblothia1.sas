...
data pde&year._2;
	&set. set pde&year._1;
	&merge. merge pde&year._1 (in=a) pde&prev_year._10 (in=b keep=bene_id bblothia_push_&prev_year.);
	by bene_id;
...
data bblothia_0713;
	...
	* timing variables;
	array ybblothia [*] ybblothia2007-ybblothia2013;
	array ybblothiadec [*] ybblothia2013 ybblothia2012 ybblothia2011 ybblothia2010 ybblothia2009 ybblothia2008 ybblothia2007 ;
	do i=1 to dim(ybblothia);
		if ybblothia[i]=1 then bblothia_lastyoo=i+2006;
		if ybblothiadec[i]=1 then bblothia_firstyoo=2014-i;
	end;

	bblothia_yearcount=bblothia_lastyoo-bblothia_firstyoo+1;

	* utilization variables;
	array util [*] bblothia_fillperiod_2007-bblothia_fillperiod_2013 bblothia_clms_2007 - bblothia_clms_2013
		bblothia_filldays_2007-bblothia_filldays_2013 bblothia_pdays_2007-bblothia_pdays_2013;
	...
	* total utilization;
	bblothia_clms=sum(of bblothia_clms_2007-bblothia_clms_2013);
	bblothia_filldays=sum(of bblothia_filldays_2007-bblothia_filldays_2013);
	bblothia_pdays=sum(of bblothia_pdays_2007-bblothia_pdays_2013);

	* timing variables;
	bblothia_minfilldt=min(of bblothia_minfilldt_2007-bblothia_minfilldt_2013);
	bblothia_maxfilldt=max(of bblothia_maxfilldt_2007-bblothia_maxfilldt_2013);
...
* create perm;
data reppoly.bblothia_0713p;
	set bblothia_0713;
run;

* checks;
proc means data=bblothia_0713; run;
