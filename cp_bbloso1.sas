...
data pde&year._2;
	&set. set pde&year._1;
	&merge. merge pde&year._1 (in=a) pde&prev_year._10 (in=b keep=bene_id bbloso_push_&prev_year.);
	by bene_id;
...
data bbloso_0713;
	...
	* timing variables;
	array ybbloso [*] ybbloso2007-ybbloso2013;
	array ybblosodec [*] ybbloso2013 ybbloso2012 ybbloso2011 ybbloso2010 ybbloso2009 ybbloso2008 ybbloso2007 ;
	do i=1 to dim(ybbloso);
		if ybbloso[i]=1 then bbloso_lastyoo=i+2006;
		if ybblosodec[i]=1 then bbloso_firstyoo=2014-i;
	end;

	bbloso_yearcount=bbloso_lastyoo-bbloso_firstyoo+1;

	* utilization variables;
	array util [*] bbloso_fillperiod_2007-bbloso_fillperiod_2013 bbloso_clms_2007 - bbloso_clms_2013
		bbloso_filldays_2007-bbloso_filldays_2013 bbloso_pdays_2007-bbloso_pdays_2013;
	...
	* total utilization;
	bbloso_clms=sum(of bbloso_clms_2007-bbloso_clms_2013);
	bbloso_filldays=sum(of bbloso_filldays_2007-bbloso_filldays_2013);
	bbloso_pdays=sum(of bbloso_pdays_2007-bbloso_pdays_2013);

	* timing variables;
	bbloso_minfilldt=min(of bbloso_minfilldt_2007-bbloso_minfilldt_2013);
	bbloso_maxfilldt=max(of bbloso_maxfilldt_2007-bbloso_maxfilldt_2013);
...
* create perm;
data reppoly.bbloso_0713p;
	set bbloso_0713;
run;

* checks;
proc means data=bbloso_0713; run;
