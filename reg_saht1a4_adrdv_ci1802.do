...
use "/disk/agedisk3/medicare.work/goldman-DUA51866/ferido-dua51866/AD/data/aht/statins+aht/statinsaht_long0714_1802.dta", replace
...
outreg2 using "./output/reg_saht1a3_1802.xls", cttop(SETUP 1) replace
...
age agesq female race_d* i.hcc4_L1 cmd_* i.pct_hsgrads4_L1 i.medinc4_L1 i.phyvis4_L1 ys_hypert ys_hyperl, or vce(cluster county07)
	...
	putexcel set "./output/ADRDv_logit_ci1802.xlsx",sheet(Main - All) modify
...
age agesq race_d* i.hcc4_L1 cmd_* i.pct_hsgrads4_L1 i.medinc4_L1 i.phyvis4_L1 ys_hypert ys_hyperl if female==1, or vce(cluster county07)
	...
	putexcel set "./output/ADRDv_logit_ci1802.xlsx",sheet(Main - Female) modify
...
age agesq race_d* i.hcc4_L1 cmd_* i.pct_hsgrads4_L1 i.medinc4_L1 i.phyvis4_L1 ys_hypert ys_hyperl if female==0, or vce(cluster county07)
	...
	putexcel set "./output/ADRDv_logit_ci1802.xlsx",sheet(Main - Male) modify
...
age agesq female race_d* i.hcc4_L1 cmd_* i.pct_hsgrads4_L1 i.medinc4_L1 i.phyvis4_L1 ys_hypert ys_hyperl, or vce(cluster county07)
	...
	putexcel set "./output/ADRDv_logit_ci1802.xlsx",sheet(Addl - All) modify
...
age agesq race_d* i.hcc4_L1 cmd_* i.pct_hsgrads4_L1 i.medinc4_L1 i.phyvis4_L1 ys_hypert ys_hyperl if female==1, or vce(cluster county07)
	...
	putexcel set "./output/ADRDv_logit_ci1802.xlsx",sheet(Addl - Female) modify
...
age agesq race_d* i.hcc4_L1 cmd_* i.pct_hsgrads4_L1 i.medinc4_L1 i.phyvis4_L1 ys_hypert ys_hyperl if female==0, or vce(cluster county07)
	...
	putexcel set "./output/ADRDv_logit_ci1802.xlsx",sheet(Addl - Male) modify
...
age agesq female i.hcc4_L1 cmd_* i.pct_hsgrads4_L1 i.medinc4_L1 i.phyvis4_L1 ys_hypert ys_hyperl if race_dw==1, or vce(cluster county07)
	...
	putexcel set "./output/ADRDv_logit_ci1802.xlsx",sheet(Main - White) modify
...
age agesq female i.hcc4_L1 cmd_* i.pct_hsgrads4_L1 i.medinc4_L1 i.phyvis4_L1 ys_hypert ys_hyperl if race_db==1, or vce(cluster county07)
	...
	putexcel set "./output/ADRDv_logit_ci1802.xlsx",sheet(Main - Black) modify
...
age agesq female i.hcc4_L1 cmd_* i.pct_hsgrads4_L1 i.medinc4_L1 i.phyvis4_L1 ys_hypert ys_hyperl if race_dh==1, or vce(cluster county07)
	...
	putexcel set "./output/ADRDv_logit_ci1802.xlsx",sheet(Main - Hispanic) modify
...
age agesq female i.hcc4_L1 cmd_* i.pct_hsgrads4_L1 i.medinc4_L1 i.phyvis4_L1 ys_hypert ys_hyperl if race_do==1, or vce(cluster county07)
	...
	putexcel set "./output/ADRDv_logit_ci1802.xlsx",sheet(Main - Other) modify
...
age agesq female i.hcc4_L1 cmd_* i.pct_hsgrads4_L1 i.medinc4_L1 i.phyvis4_L1 ys_hypert ys_hyperl if race_dw==1, or vce(cluster county07)
	...
	putexcel set "./output/ADRDv_logit_ci1802.xlsx",sheet(Addl - White) modify
...
age agesq female i.hcc4_L1 cmd_* i.pct_hsgrads4_L1 i.medinc4_L1 i.phyvis4_L1 ys_hypert ys_hyperl if race_db==1, or vce(cluster county07)
	...
	putexcel set "./output/ADRDv_logit_ci1802.xlsx",sheet(Addl - Black) modify
...
age agesq female i.hcc4_L1 cmd_* i.pct_hsgrads4_L1 i.medinc4_L1 i.phyvis4_L1 ys_hypert ys_hyperl if race_dh==1, or vce(cluster county07)
	...
	putexcel set "./output/ADRDv_logit_ci1802.xlsx",sheet(Addl - Hispanic) modify
...
age agesq female i.hcc4_L1 cmd_* i.pct_hsgrads4_L1 i.medinc4_L1 i.phyvis4_L1 ys_hypert ys_hyperl if race_do==1, or vce(cluster county07)
	...
	putexcel set "./output/ADRDv_logit_ci1802.xlsx",sheet(Addl - Other) modify
...
age agesq  i.hcc4_L1 cmd_* i.pct_hsgrads4_L1 i.medinc4_L1 i.phyvis4_L1 ys_hypert ys_hyperl if race_dw==1 & female==1, vce(cluster county07)
	...
	putexcel set "./output/ADRDv_logit_ci1802.xlsx",sheet(Main - Female White) modify
...
age agesq  i.hcc4_L1 cmd_* i.pct_hsgrads4_L1 i.medinc4_L1 i.phyvis4_L1 ys_hypert ys_hyperl if race_db==1 & female==1, vce(cluster county07)
	...
	putexcel set "./output/ADRDv_logit_ci1802.xlsx",sheet(Main - Female Black) modify
...
age agesq  i.hcc4_L1 cmd_* i.pct_hsgrads4_L1 i.medinc4_L1 i.phyvis4_L1 ys_hypert ys_hyperl if race_dh==1 & female==1, vce(cluster county07)
	...
	putexcel set "./output/ADRDv_logit_ci1802.xlsx",sheet(Main - Female Hispanic) modify
...
age agesq  i.hcc4_L1 cmd_* i.pct_hsgrads4_L1 i.medinc4_L1 i.phyvis4_L1 ys_hypert ys_hyperl if race_do==1 & female==1, vce(cluster county07)
	...
	putexcel set "./output/ADRDv_logit_ci1802.xlsx",sheet(Main - Female Other) modify
...
age agesq  i.hcc4_L1 cmd_* i.pct_hsgrads4_L1 i.medinc4_L1 i.phyvis4_L1 ys_hypert ys_hyperl if race_dw==1 & female==1, vce(cluster county07)
	...
	putexcel set "./output/ADRDv_logit_ci1802.xlsx",sheet(Addl - Female White) modify
...
age agesq  i.hcc4_L1 cmd_* i.pct_hsgrads4_L1 i.medinc4_L1 i.phyvis4_L1 ys_hypert ys_hyperl if race_db==1 & female==1, vce(cluster county07)
	...
	putexcel set "./output/ADRDv_logit_ci1802.xlsx",sheet(Addl - Female Black) modify
...
age agesq  i.hcc4_L1 cmd_* i.pct_hsgrads4_L1 i.medinc4_L1 i.phyvis4_L1 ys_hypert ys_hyperl if race_dh==1 & female==1, vce(cluster county07)
	...
	putexcel set "./output/ADRDv_logit_ci1802.xlsx",sheet(Addl - Female Hispanic) modify
...
age agesq  i.hcc4_L1 cmd_* i.pct_hsgrads4_L1 i.medinc4_L1 i.phyvis4_L1 ys_hypert ys_hyperl if race_do==1 & female==1, vce(cluster county07)
	...
	putexcel set "./output/ADRDv_logit_ci1802.xlsx",sheet(Addl - Female Other) modify
...
age agesq  i.hcc4_L1 cmd_* i.pct_hsgrads4_L1 i.medinc4_L1 i.phyvis4_L1 ys_hypert ys_hyperl if race_dw==1 & female==0, vce(cluster county07)
	...
	putexcel set "./output/ADRDv_logit_ci1802.xlsx",sheet(Main - Male White) modify
...
age agesq  i.hcc4_L1 cmd_* i.pct_hsgrads4_L1 i.medinc4_L1 i.phyvis4_L1 ys_hypert ys_hyperl if race_db==1 & female==0, vce(cluster county07)
	...
	putexcel set "./output/ADRDv_logit_ci1802.xlsx",sheet(Main - Male Black) modify
...
age agesq  i.hcc4_L1 cmd_* i.pct_hsgrads4_L1 i.medinc4_L1 i.phyvis4_L1 ys_hypert ys_hyperl if race_dh==1 & female==0, vce(cluster county07)
	...
	putexcel set "./output/ADRDv_logit_ci1802.xlsx",sheet(Main - Male Hispanic) modify
...
age agesq  i.hcc4_L1 cmd_* i.pct_hsgrads4_L1 i.medinc4_L1 i.phyvis4_L1 ys_hypert ys_hyperl if race_do==1 & female==0, vce(cluster county07)
	...
	putexcel set "./output/ADRDv_logit_ci1802.xlsx",sheet(Main - Male Other) modify
...
age agesq  i.hcc4_L1 cmd_* i.pct_hsgrads4_L1 i.medinc4_L1 i.phyvis4_L1 ys_hypert ys_hyperl if race_dw==1 & female==0, vce(cluster county07)
	...
	putexcel set "./output/ADRDv_logit_ci1802.xlsx",sheet(Addl - Male White) modify
...
age agesq  i.hcc4_L1 cmd_* i.pct_hsgrads4_L1 i.medinc4_L1 i.phyvis4_L1 ys_hypert ys_hyperl if race_db==1 & female==0, vce(cluster county07)
	...
	putexcel set "./output/ADRDv_logit_ci1802.xlsx",sheet(Addl - Male Black) modify
...
age agesq  i.hcc4_L1 cmd_* i.pct_hsgrads4_L1 i.medinc4_L1 i.phyvis4_L1 ys_hypert ys_hyperl if race_dh==1 & female==0, vce(cluster county07)
	...
	putexcel set "./output/ADRDv_logit_ci1802.xlsx",sheet(Addl - Male Hispanic) modify
...
age agesq  i.hcc4_L1 cmd_* i.pct_hsgrads4_L1 i.medinc4_L1 i.phyvis4_L1 ys_hypert ys_hyperl if race_do==1 & female==0, vce(cluster county07)
	...
	putexcel set "./output/ADRDv_logit_ci1802.xlsx",sheet(Addl - Male Other) modify
