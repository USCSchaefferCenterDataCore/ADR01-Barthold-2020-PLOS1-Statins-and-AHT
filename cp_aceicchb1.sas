...
data pde&year._2;
	&set. set pde&year._1;
	&merge. merge pde&year._1 (in=a) pde&prev_year._10 (in=b keep=bene_id aceicchb_push_&prev_year.);
	by bene_id;
...
data aceicchb_0713;
	...
	* timing variables;
	array yaceicchb [*] yaceicchb2007-yaceicchb2013;
	array yaceicchbdec [*] yaceicchb2013 yaceicchb2012 yaceicchb2011 yaceicchb2010 yaceicchb2009 yaceicchb2008 yaceicchb2007 ;
	do i=1 to dim(yaceicchb);
		if yaceicchb[i]=1 then aceicchb_lastyoo=i+2006;
		if yaceicchbdec[i]=1 then aceicchb_firstyoo=2014-i;
	end;

	aceicchb_yearcount=aceicchb_lastyoo-aceicchb_firstyoo+1;

	* utilization variables;
	array util [*] aceicchb_fillperiod_2007-aceicchb_fillperiod_2013 aceicchb_clms_2007 - aceicchb_clms_2013
		aceicchb_filldays_2007-aceicchb_filldays_2013 aceicchb_pdays_2007-aceicchb_pdays_2013;
	...
	* total utilization;
	aceicchb_clms=sum(of aceicchb_clms_2007-aceicchb_clms_2013);
	aceicchb_filldays=sum(of aceicchb_filldays_2007-aceicchb_filldays_2013);
	aceicchb_pdays=sum(of aceicchb_pdays_2007-aceicchb_pdays_2013);

	* timing variables;
	aceicchb_minfilldt=min(of aceicchb_minfilldt_2007-aceicchb_minfilldt_2013);
	aceicchb_maxfilldt=max(of aceicchb_maxfilldt_2007-aceicchb_maxfilldt_2013);
...
* create perm;
data reppoly.aceicchb_0713p;
	set aceicchb_0713;
run;

* checks;
proc means data=aceicchb_0713; run;
