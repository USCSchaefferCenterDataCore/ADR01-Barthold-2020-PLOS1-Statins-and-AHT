...
data pde&year._2;
	&set. set pde&year._1;
	&merge. merge pde&year._1 (in=a) pde&prev_year._10 (in=b keep=bene_id loopso_push_&prev_year.);
	by bene_id;
...
data loopso_0713;
	...
	* timing variables;
	array yloopso [*] yloopso2007-yloopso2013;
	array yloopsodec [*] yloopso2013 yloopso2012 yloopso2011 yloopso2010 yloopso2009 yloopso2008 yloopso2007 ;
	do i=1 to dim(yloopso);
		if yloopso[i]=1 then loopso_lastyoo=i+2006;
		if yloopsodec[i]=1 then loopso_firstyoo=2014-i;
	end;

	loopso_yearcount=loopso_lastyoo-loopso_firstyoo+1;

	* utilization variables;
	array util [*] loopso_fillperiod_2007-loopso_fillperiod_2013 loopso_clms_2007 - loopso_clms_2013
		loopso_filldays_2007-loopso_filldays_2013 loopso_pdays_2007-loopso_pdays_2013;
	...
	* total utilization;
	loopso_clms=sum(of loopso_clms_2007-loopso_clms_2013);
	loopso_filldays=sum(of loopso_filldays_2007-loopso_filldays_2013);
	loopso_pdays=sum(of loopso_pdays_2007-loopso_pdays_2013);

	* timing variables;
	loopso_minfilldt=min(of loopso_minfilldt_2007-loopso_minfilldt_2013);
	loopso_maxfilldt=max(of loopso_maxfilldt_2007-loopso_maxfilldt_2013);
...
* create perm;
data reppoly.loopso_0713p;
	set loopso_0713;
run;

* checks;
proc means data=loopso_0713; run;
