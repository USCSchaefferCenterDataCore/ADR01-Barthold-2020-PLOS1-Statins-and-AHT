...
data pde&year._2;
	&set. set pde&year._1;
	&merge. merge pde&year._1 (in=a) reppoly.a2rbthia_&prev_year.p (in=b keep=bene_id a2rbthia_push_&prev_year.);
	by bene_id;
...
*/
%a2rbthiapull(2014,2013,,*);

/*********** Merge a2rbthia 07-14 **********/
data a2rbthia_0714;
	merge reppoly.a2rbthia_2007p (in=b)
				reppoly.a2rbthia_2008p (in=c)
				reppoly.a2rbthia_2009p (in=d)
				reppoly.a2rbthia_2010p (in=e)
				reppoly.a2rbthia_2011p (in=f)
				reppoly.a2rbthia_2012p (in=g)
				reppoly.a2rbthia_2013p (in=h)
				reppoly.a2rbthia_2014p (in=i);
	by bene_id;
	ya2rbthia2007=b;
	ya2rbthia2008=c;
	ya2rbthia2009=d;
	...
	* timing variables;
	array ya2rbthia [*] ya2rbthia2007-ya2rbthia2014;
	array ya2rbthiadec [*] ya2rbthia2014 ya2rbthia2013 ya2rbthia2012 ya2rbthia2011 ya2rbthia2010 ya2rbthia2009 ya2rbthia2008 ya2rbthia2007 ;
	do i=1 to dim(ya2rbthia);
		if ya2rbthia[i]=1 then a2rbthia_lastyoo=i+2006;
		if ya2rbthiadec[i]=1 then a2rbthia_firstyoo=2015-i;
	end;

	a2rbthia_yearcount=a2rbthia_lastyoo-a2rbthia_firstyoo+1;

	* utilization variables;
	array util [*] a2rbthia_fillperiod_2007-a2rbthia_fillperiod_2014 a2rbthia_clms_2007 - a2rbthia_clms_2014
		a2rbthia_filldays_2007-a2rbthia_filldays_2014 a2rbthia_pdays_2007-a2rbthia_pdays_2014;
	...
	* total utilization;
	a2rbthia_clms=sum(of a2rbthia_clms_2007-a2rbthia_clms_2014);
	a2rbthia_filldays=sum(of a2rbthia_filldays_2007-a2rbthia_filldays_2014);
	a2rbthia_pdays=sum(of a2rbthia_pdays_2007-a2rbthia_pdays_2014);

	* timing variables;
	a2rbthia_minfilldt=min(of a2rbthia_minfilldt_2007-a2rbthia_minfilldt_2014);
	a2rbthia_maxfilldt=max(of a2rbthia_maxfilldt_2007-a2rbthia_maxfilldt_2014);
...
* create perm;
data reppoly.a2rbthia_0714p;
	set a2rbthia_0714;
run;

* checks;
proc means data=a2rbthia_0714; run;
