...
data pde&year._2;
	&set. set pde&year._1;
	&merge. merge pde&year._1 (in=a) pde&prev_year._10 (in=b keep=bene_id cchbso_push_&prev_year.);
	by bene_id;
...
data cchbso_0713;
	...
	* timing variables;
	array ycchbso [*] ycchbso2007-ycchbso2013;
	array ycchbsodec [*] ycchbso2013 ycchbso2012 ycchbso2011 ycchbso2010 ycchbso2009 ycchbso2008 ycchbso2007 ;
	do i=1 to dim(ycchbso);
		if ycchbso[i]=1 then cchbso_lastyoo=i+2006;
		if ycchbsodec[i]=1 then cchbso_firstyoo=2014-i;
	end;

	cchbso_yearcount=cchbso_lastyoo-cchbso_firstyoo+1;

	* utilization variables;
	array util [*] cchbso_fillperiod_2007-cchbso_fillperiod_2013 cchbso_clms_2007 - cchbso_clms_2013
		cchbso_filldays_2007-cchbso_filldays_2013 cchbso_pdays_2007-cchbso_pdays_2013;
	...
	* total utilization;
	cchbso_clms=sum(of cchbso_clms_2007-cchbso_clms_2013);
	cchbso_filldays=sum(of cchbso_filldays_2007-cchbso_filldays_2013);
	cchbso_pdays=sum(of cchbso_pdays_2007-cchbso_pdays_2013);

	* timing variables;
	cchbso_minfilldt=min(of cchbso_minfilldt_2007-cchbso_minfilldt_2013);
	cchbso_maxfilldt=max(of cchbso_maxfilldt_2007-cchbso_maxfilldt_2013);
...
* create perm;
data reppoly.cchbso_0713p;
	set cchbso_0713;
run;

* checks;
proc means data=cchbso_0713; run;
