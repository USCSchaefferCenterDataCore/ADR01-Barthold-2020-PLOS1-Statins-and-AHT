...
use "/disk/agedisk3/medicare.work/goldman-DUA51866/ferido-dua51866/AD/data/aht/statins+aht/statinsaht_long0714_2702.dta", replace
...
//drop hypertension & hyperlipidemia variable
drop cmd_hyp
drop cmd_hyperl
...
//setup outreg
logistic ADRDv_inc ras_user_L1, vce(cluster county07)
outreg2 using "./output/reg_saht1a3_2702.xls", cttop(SETUP 1) replace
...
//Just main terms
/*
logistic ADRDv_inc ator_user_L12 pra_user_L12 rosu_user_L12 sim_user_L12 acei_user_L12 a2rb_user_L12 age agesq female race_d* i.hcc4_L1 cmd_* i.pct_hsgrads4_L1 i.medinc4_L1 i.phyvis4_L1 ys_hypert ys_hyperl, vce(cluster county07)
outreg2 using "./output/reg_saht1a3.xls", cttop(All) append
logistic ADRDv_inc ator_user_L12 pra_user_L12 rosu_user_L12 sim_user_L12 acei_user_L12 a2rb_user_L12 oth4_user_L12 age agesq female race_d* i.hcc4_L1 cmd_* i.pct_hsgrads4_L1 i.medinc4_L1 i.phyvis4_L1 ys_hypert ys_hyperl, vce(cluster county07)
outreg2 using "./output/reg_saht1a3.xls", cttop(All) append
*/

//Just interactions
//All
logit ADRDv_inc int_ator_acei_L12 int_sim_acei_L12 int_pra_acei_L12 int_rosu_acei_L12 ///
...
age agesq female race_d* i.hcc4_L1 cmd_* i.pct_hsgrads4_L1 i.medinc4_L1 i.phyvis4_L1 ys_hypert ys_hyperl, or vce(cluster county07)
	...
	putexcel set "./output/ADRDv_logit_ci2702.xlsx",sheet(Main - All) modify
...
age agesq race_d* i.hcc4_L1 cmd_* i.pct_hsgrads4_L1 i.medinc4_L1 i.phyvis4_L1 ys_hypert ys_hyperl if female==1, or vce(cluster county07)
	...
	putexcel set "./output/ADRDv_logit_ci2702.xlsx",sheet(Main - Female) modify
...
age agesq race_d* i.hcc4_L1 cmd_* i.pct_hsgrads4_L1 i.medinc4_L1 i.phyvis4_L1 ys_hypert ys_hyperl if female==0, or vce(cluster county07)
	...
	putexcel set "./output/ADRDv_logit_ci2702.xlsx",sheet(Main - Male) modify
...
age agesq female race_d* i.hcc4_L1 cmd_* i.pct_hsgrads4_L1 i.medinc4_L1 i.phyvis4_L1 ys_hypert ys_hyperl, or vce(cluster county07)
	...
	putexcel set "./output/ADRDv_logit_ci2702.xlsx",sheet(Addl - All) modify
...
age agesq race_d* i.hcc4_L1 cmd_* i.pct_hsgrads4_L1 i.medinc4_L1 i.phyvis4_L1 ys_hypert ys_hyperl if female==1, or vce(cluster county07)
	...
	putexcel set "./output/ADRDv_logit_ci2702.xlsx",sheet(Addl - Female) modify
...
age agesq race_d* i.hcc4_L1 cmd_* i.pct_hsgrads4_L1 i.medinc4_L1 i.phyvis4_L1 ys_hypert ys_hyperl if female==0, or vce(cluster county07)
	...
	putexcel set "./output/ADRDv_logit_ci2702.xlsx",sheet(Addl - Male) modify
...
age agesq female i.hcc4_L1 cmd_* i.pct_hsgrads4_L1 i.medinc4_L1 i.phyvis4_L1 ys_hypert ys_hyperl if race_dw==1, or vce(cluster county07)
	...
	putexcel set "./output/ADRDv_logit_ci2702.xlsx",sheet(Main - White) modify
...
age agesq female i.hcc4_L1 cmd_* i.pct_hsgrads4_L1 i.medinc4_L1 i.phyvis4_L1 ys_hypert ys_hyperl if race_db==1, or vce(cluster county07)
	...
	putexcel set "./output/ADRDv_logit_ci2702.xlsx",sheet(Main - Black) modify
...
age agesq female i.hcc4_L1 cmd_* i.pct_hsgrads4_L1 i.medinc4_L1 i.phyvis4_L1 ys_hypert ys_hyperl if race_dh==1, or vce(cluster county07)
	...
	putexcel set "./output/ADRDv_logit_ci2702.xlsx",sheet(Main - Hispanic) modify
...
age agesq female i.hcc4_L1 cmd_* i.pct_hsgrads4_L1 i.medinc4_L1 i.phyvis4_L1 ys_hypert ys_hyperl if race_do==1, or vce(cluster county07)
	...
	putexcel set "./output/ADRDv_logit_ci2702.xlsx",sheet(Main - Other) modify
...
age agesq female i.hcc4_L1 cmd_* i.pct_hsgrads4_L1 i.medinc4_L1 i.phyvis4_L1 ys_hypert ys_hyperl if race_dw==1, or vce(cluster county07)
	...
	putexcel set "./output/ADRDv_logit_ci2702.xlsx",sheet(Addl - White) modify
...
age agesq female i.hcc4_L1 cmd_* i.pct_hsgrads4_L1 i.medinc4_L1 i.phyvis4_L1 ys_hypert ys_hyperl if race_db==1, or vce(cluster county07)
	...
	putexcel set "./output/ADRDv_logit_ci2702.xlsx",sheet(Addl - Black) modify
...
age agesq female i.hcc4_L1 cmd_* i.pct_hsgrads4_L1 i.medinc4_L1 i.phyvis4_L1 ys_hypert ys_hyperl if race_dh==1, or vce(cluster county07)
	...
	putexcel set "./output/ADRDv_logit_ci2702.xlsx",sheet(Addl - Hispanic) modify
...
age agesq female i.hcc4_L1 cmd_* i.pct_hsgrads4_L1 i.medinc4_L1 i.phyvis4_L1 ys_hypert ys_hyperl if race_do==1, or vce(cluster county07)
	...
	putexcel set "./output/ADRDv_logit_ci2702.xlsx",sheet(Addl - Other) modify
...
age agesq  i.hcc4_L1 cmd_* i.pct_hsgrads4_L1 i.medinc4_L1 i.phyvis4_L1 ys_hypert ys_hyperl if race_dw==1 & female==1, vce(cluster county07)
	...
	putexcel set "./output/ADRDv_logit_ci2702.xlsx",sheet(Main - Female White) modify
...
age agesq  i.hcc4_L1 cmd_* i.pct_hsgrads4_L1 i.medinc4_L1 i.phyvis4_L1 ys_hypert ys_hyperl if race_db==1 & female==1, vce(cluster county07)
	...
	putexcel set "./output/ADRDv_logit_ci2702.xlsx",sheet(Main - Female Black) modify
...
age agesq  i.hcc4_L1 cmd_* i.pct_hsgrads4_L1 i.medinc4_L1 i.phyvis4_L1 ys_hypert ys_hyperl if race_dh==1 & female==1, vce(cluster county07)
	...
	putexcel set "./output/ADRDv_logit_ci2702.xlsx",sheet(Main - Female Hispanic) modify
...
age agesq  i.hcc4_L1 cmd_* i.pct_hsgrads4_L1 i.medinc4_L1 i.phyvis4_L1 ys_hypert ys_hyperl if race_do==1 & female==1, vce(cluster county07)
	...
	putexcel set "./output/ADRDv_logit_ci2702.xlsx",sheet(Main - Female Other) modify
...
age agesq  i.hcc4_L1 cmd_* i.pct_hsgrads4_L1 i.medinc4_L1 i.phyvis4_L1 ys_hypert ys_hyperl if race_dw==1 & female==1, vce(cluster county07)
	...
	putexcel set "./output/ADRDv_logit_ci2702.xlsx",sheet(Addl - Female White) modify
...
age agesq  i.hcc4_L1 cmd_* i.pct_hsgrads4_L1 i.medinc4_L1 i.phyvis4_L1 ys_hypert ys_hyperl if race_db==1 & female==1, vce(cluster county07)
	...
	putexcel set "./output/ADRDv_logit_ci2702.xlsx",sheet(Addl - Female Black) modify
...
age agesq  i.hcc4_L1 cmd_* i.pct_hsgrads4_L1 i.medinc4_L1 i.phyvis4_L1 ys_hypert ys_hyperl if race_dh==1 & female==1, vce(cluster county07)
	...
	putexcel set "./output/ADRDv_logit_ci2702.xlsx",sheet(Addl - Female Hispanic) modify
...
age agesq  i.hcc4_L1 cmd_* i.pct_hsgrads4_L1 i.medinc4_L1 i.phyvis4_L1 ys_hypert ys_hyperl if race_do==1 & female==1, vce(cluster county07)
	...
	putexcel set "./output/ADRDv_logit_ci2702.xlsx",sheet(Addl - Female Other) modify
...
age agesq  i.hcc4_L1 cmd_* i.pct_hsgrads4_L1 i.medinc4_L1 i.phyvis4_L1 ys_hypert ys_hyperl if race_dw==1 & female==0, vce(cluster county07)
	...
	putexcel set "./output/ADRDv_logit_ci2702.xlsx",sheet(Main - Male White) modify
...
age agesq  i.hcc4_L1 cmd_* i.pct_hsgrads4_L1 i.medinc4_L1 i.phyvis4_L1 ys_hypert ys_hyperl if race_db==1 & female==0, vce(cluster county07)
	...
	putexcel set "./output/ADRDv_logit_ci2702.xlsx",sheet(Main - Male Black) modify
...
age agesq  i.hcc4_L1 cmd_* i.pct_hsgrads4_L1 i.medinc4_L1 i.phyvis4_L1 ys_hypert ys_hyperl if race_dh==1 & female==0, vce(cluster county07)
	...
	putexcel set "./output/ADRDv_logit_ci2702.xlsx",sheet(Main - Male Hispanic) modify
...
age agesq  i.hcc4_L1 cmd_* i.pct_hsgrads4_L1 i.medinc4_L1 i.phyvis4_L1 ys_hypert ys_hyperl if race_do==1 & female==0, vce(cluster county07)
	...
	putexcel set "./output/ADRDv_logit_ci2702.xlsx",sheet(Main - Male Other) modify
...
age agesq  i.hcc4_L1 cmd_* i.pct_hsgrads4_L1 i.medinc4_L1 i.phyvis4_L1 ys_hypert ys_hyperl if race_dw==1 & female==0, vce(cluster county07)
	...
	putexcel set "./output/ADRDv_logit_ci2702.xlsx",sheet(Addl - Male White) modify
...
age agesq  i.hcc4_L1 cmd_* i.pct_hsgrads4_L1 i.medinc4_L1 i.phyvis4_L1 ys_hypert ys_hyperl if race_db==1 & female==0, vce(cluster county07)
	...
	putexcel set "./output/ADRDv_logit_ci2702.xlsx",sheet(Addl - Male Black) modify
...
age agesq  i.hcc4_L1 cmd_* i.pct_hsgrads4_L1 i.medinc4_L1 i.phyvis4_L1 ys_hypert ys_hyperl if race_dh==1 & female==0, vce(cluster county07)
	...
	putexcel set "./output/ADRDv_logit_ci2702.xlsx",sheet(Addl - Male Hispanic) modify
...
age agesq  i.hcc4_L1 cmd_* i.pct_hsgrads4_L1 i.medinc4_L1 i.phyvis4_L1 ys_hypert ys_hyperl if race_do==1 & female==0, vce(cluster county07)
	...
	putexcel set "./output/ADRDv_logit_ci2702.xlsx",sheet(Addl - Male Other) modify
...
/*
logistic ADRDv_inc int_ator_acei_L12 int_pra_acei_L12 int_rosu_acei_L12 ///
...
outreg2 using "./output/reg_saht1a3.xls", cttop(All) append
logistic ADRDv_inc int_ator_acei_L12 int_sim_acei_L12 int_pra_acei_L12 int_rosu_acei_L12 ///
				int_ator_a2rb_L12 int_sim_a2rb_L12 int_pra_a2rb_L12 int_rosu_a2rb_L12 ///
...
/*
logistic ADRDv_inc ator_user_L12 pra_user_L12 rosu_user_L12 sim_user_L12 acei_user_L12 a2rb_user_L12 ///
				int_ator_acei_L12 int_sim_acei_L12 int_pra_acei_L12 int_rosu_acei_L12 ///
				int_ator_a2rb_L12 int_sim_a2rb_L12 int_pra_a2rb_L12 int_rosu_a2rb_L12 ///
age agesq female race_d* i.hcc4_L1 cmd_* i.pct_hsgrads4_L1 i.medinc4_L1 i.phyvis4_L1 ys_hypert ys_hyperl, vce(cluster county07)
outreg2 using "./output/reg_saht1a3.xls", cttop(All) append
logistic ADRDv_inc ator_user_L12 pra_user_L12 rosu_user_L12 acei_user_L12 a2rb_user_L12 ///
				int_ator_acei_L12 int_pra_acei_L12 int_rosu_acei_L12 ///
				int_ator_a2rb_L12 int_pra_a2rb_L12 int_rosu_a2rb_L12 ///
age agesq female race_d* i.hcc4_L1 cmd_* i.pct_hsgrads4_L1 i.medinc4_L1 i.phyvis4_L1 ys_hypert ys_hyperl, vce(cluster county07)
outreg2 using "./output/reg_saht1a3.xls", cttop(All) append
logistic ADRDv_inc ator_user_L12 pra_user_L12 rosu_user_L12 sim_user_L12 acei_user_L12 a2rb_user_L12 oth4_user_L12 ///
				int_ator_acei_L12 int_sim_acei_L12 int_pra_acei_L12 int_rosu_acei_L12 ///
				int_ator_a2rb_L12 int_sim_a2rb_L12 int_pra_a2rb_L12 int_rosu_a2rb_L12 ///
				int_ator_oth4_L12 int_pra_oth4_L12 int_rosu_oth4_L12 int_sim_oth4_L12 ///
age agesq female race_d* i.hcc4_L1 cmd_* i.pct_hsgrads4_L1 i.medinc4_L1 i.phyvis4_L1 ys_hypert ys_hyperl, vce(cluster county07)
outreg2 using "./output/reg_saht1a3.xls", cttop(All) append
logistic ADRDv_inc ator_user_L12 pra_user_L12 rosu_user_L12 acei_user_L12 a2rb_user_L12 oth4_user_L12 ///
				int_ator_acei_L12 int_pra_acei_L12 int_rosu_acei_L12 ///
				int_ator_a2rb_L12 int_pra_a2rb_L12 int_rosu_a2rb_L12 ///
				int_ator_oth4_L12 int_pra_oth4_L12 int_rosu_oth4_L12 ///
age agesq female race_d* i.hcc4_L1 cmd_* i.pct_hsgrads4_L1 i.medinc4_L1 i.phyvis4_L1 ys_hypert ys_hyperl, vce(cluster county07)
