...
data pde&year._2;
	&set. set pde&year._1;
	&merge. merge pde&year._1 (in=a) reppoly.aceithia_&prev_year.p (in=b keep=bene_id aceithia_push_&prev_year.);
	by bene_id;
...
*/
%aceithiapull(2014,2013,,*);

/*********** Merge aceithia 07-14 **********/
data aceithia_0714;
	merge reppoly.aceithia_2007p (in=b)
				reppoly.aceithia_2008p (in=c)
				reppoly.aceithia_2009p (in=d)
				reppoly.aceithia_2010p (in=e)
				reppoly.aceithia_2011p (in=f)
				reppoly.aceithia_2012p (in=g)
				reppoly.aceithia_2013p (in=h)
				reppoly.aceithia_2014p (in=i);
	by bene_id;
	yaceithia2007=b;
	yaceithia2008=c;
	yaceithia2009=d;
	...
	* timing variables;
	array yaceithia [*] yaceithia2007-yaceithia2014;
	array yaceithiadec [*] yaceithia2014 yaceithia2013 yaceithia2012 yaceithia2011 yaceithia2010 yaceithia2009 yaceithia2008 yaceithia2007 ;
	do i=1 to dim(yaceithia);
		if yaceithia[i]=1 then aceithia_lastyoo=i+2006;
		if yaceithiadec[i]=1 then aceithia_firstyoo=2015-i;
	end;

	aceithia_yearcount=aceithia_lastyoo-aceithia_firstyoo+1;

	* utilization variables;
	array util [*] aceithia_fillperiod_2007-aceithia_fillperiod_2014 aceithia_clms_2007 - aceithia_clms_2014
		aceithia_filldays_2007-aceithia_filldays_2014 aceithia_pdays_2007-aceithia_pdays_2014;
	...
	* total utilization;
	aceithia_clms=sum(of aceithia_clms_2007-aceithia_clms_2014);
	aceithia_filldays=sum(of aceithia_filldays_2007-aceithia_filldays_2014);
	aceithia_pdays=sum(of aceithia_pdays_2007-aceithia_pdays_2014);

	* timing variables;
	aceithia_minfilldt=min(of aceithia_minfilldt_2007-aceithia_minfilldt_2014);
	aceithia_maxfilldt=max(of aceithia_maxfilldt_2007-aceithia_maxfilldt_2014);
...
* create perm;
data reppoly.aceithia_0714p;
	set aceithia_0714;
run;

* checks;
proc means data=aceithia_0714; run;
