...
set more off
capture log close
log using statinsaht_prepreg902.log, replace text
...
////////////////////////////////////////////////////////////////////////////////
//																			  //
//					Bring in AHT and statins								  //
//																			  //
////////////////////////////////////////////////////////////////////////////////
////////////////////////////////////////////////////////////////////////////////

use "/disk/agedisk3/medicare.work/goldman-DUA51866/ferido-dua51866/AD/data/aht/poly/ahtco_long0714a.dta", replace
tempfile statinsaht
save `statinsaht', replace

use "/disk/agedisk3/medicare.work/goldman-DUA51866/ferido-dua51866/AD/data/aht/statins+aht/statins_long0714a.dta", replace
merge 1:1 bene_id year using `statinsaht'
//keep if _m==3
drop _m

local vars "pdays clms"
foreach i in `vars'{
	replace atorso_`i' = 0 if atorso_`i'==.
	replace atorcchb_`i' = 0 if atorcchb_`i'==.
	replace praso_`i' = 0 if praso_`i'==.
	replace rosuso_`i' = 0 if rosuso_`i'==.
	replace simso_`i' = 0 if simso_`i'==.
}
local vars "pdays clms"
foreach i in `vars'{
...
////////////////////////////////////////////////////////////////////////////////
//																			  //
//			Merge in AD info, and CCW info, geoedu							  //
//																			  //
////////////////////////////////////////////////////////////////////////////////
////////////////////////////////////////////////////////////////////////////////

use "/disk/agedisk3/medicare.work/goldman-DUA51866/ferido-dua51866/AD/data/aht/base/adrdv4_0814.dta", replace

keep bene_id ///
ADv_dt ADv_year ADv_age ADv_ageD  ///
ADRDv_dt ADRDv_year ADRDv_age ADRDv_ageD ///

merge 1:m bene_id using `statinsaht'
drop if _m==1  //dropping those in the AD file, but not the statinsaht file
drop _m
save `statinsaht', replace

use "/disk/agedisk3/medicare.work/goldman-DUA51866/ferido-dua51866/AD/data/aht/base/hcc_long0714.dta", replace
merge 1:1 bene_id year using `statinsaht'
drop if _m==1 //dropping those in the hcc file, but not in the statinsaht file. 
drop _m
...
use "/disk/agedisk3/medicare.work/goldman-DUA51866/ferido-dua51866/AD/data/aht/base/phy_long0614.dta", replace
merge 1:1 bene_id year using `statinsaht'
drop if _m==1 //dropping those in the phy file, but not in the statinsaht file. 
drop _m
...
use "/disk/agedisk3/medicare.work/goldman-DUA51866/ferido-dua51866/AD/data/aht/base/ccw_0714.dta", replace
...
merge 1:m bene_id using `statinsaht'
drop if _m==1 //dropping those in the ccw file, but not in the statinsaht file
drop _m
save `statinsaht', replace

use "/disk/agedisk3/medicare.work/goldman-DUA51866/ferido-dua51866/AD/data/aht/base/geoses_long0714.dta", replace
merge 1:1 bene_id year using `statinsaht'
drop if _m==1 //dropping those in the geoses file, but not in the statinsaht file. 
drop _m
...
xfill county07, i(idn)
replace county07 = fips_county if year==2014 & county07==""
xfill county07, i(idn)
...
use "/disk/agedisk3/medicare.work/goldman-DUA51866/ferido-dua51866/AD/data/aht/addrug/adrx_long0714.dta", replace
...
compress
save "/disk/agedisk3/medicare.work/goldman-DUA51866/ferido-dua51866/AD/data/aht/statins+aht/statinsaht_long0714b.dta", replace
...
compress
save "/disk/agedisk3/medicare.work/goldman-DUA51866/ferido-dua51866/AD/data/aht/statins+aht/statinsaht_long0714c902.dta", replace
*/
////////////////////////////////////////////////////////////////////////////////
////////////////////////////////////////////////////////////////////////////////
//																			  //
...
////////////////////////////////////////////////////////////////////////////////
////////////////////////////////////////////////////////////////////////////////
use "/disk/agedisk3/medicare.work/goldman-DUA51866/ferido-dua51866/AD/data/aht/statins+aht/statinsaht_long0714c902.dta", replace
egen idn = group(bene_id)
...
*/
compress
save "/disk/agedisk3/medicare.work/goldman-DUA51866/ferido-dua51866/AD/data/aht/statins+aht/statinsaht_long0714_902.dta", replace
